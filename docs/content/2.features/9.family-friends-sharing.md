...
* Focus & Motivation hub data (`focus_domains`, `focuses`, `focus_checkins` tables) — daily/weekly/long-term intentions and reflections are personal and **never** shared or delegated, even with `can_view_reports`. Strictly owner-only.
