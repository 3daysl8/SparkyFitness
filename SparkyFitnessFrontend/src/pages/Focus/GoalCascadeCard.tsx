    ...
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      <Card className="overflow-hidden border shadow-sm transition-all hover:shadow-md">
        ...
        <CollapsibleTrigger asChild>
          <CardHeader className="cursor-pointer border-b bg-muted/30 py-3 px-4">
              ...
              <div className="rounded-lg border border-amber-500/20 bg-amber-500/5 p-3 dark:bg-amber-950/10">
                <div className="flex items-start justify-between gap-2">
                  <div className="space-y-1">
                    ...
                    {weekly.target_type === 'numeric' &&
                      weekly.target_value && (
                        <div className="flex items-center gap-1.5 text-[11px] text-muted-foreground">
                          <span className="font-semibold text-amber-600 dark:text-amber-400">
                            {t('focus.targetGoal', 'Target')}:{' '}
                            {weekly.target_value} {weekly.unit || 'units'}
                          </span>
                        </div>
                      )}
                  </div>
            ...
            {dailyList.length > 0 && (
              <div className="flex items-center gap-2 pl-4 text-muted-foreground/50">
                ...
                <span className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground">
                  {t(
                    'focus.anchoredDaily',
                    'Anchored in daily habits & WOOP plan'
                  )}{' '}
                  ➔
                </span>
              </div>
